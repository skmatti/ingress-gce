...
func (t *Translator) getServicePort(id utils.ServicePortID, params *getServicePortParams, namer *namer_util.Namer) (*utils.ServicePort, error) {
	...
	svcPort := &utils.ServicePort{
		...
		BackendNamer: namer_util.NewBackendNamer(namer),
	}
...
func (t *Translator) TranslateIngress(ing *v1beta1.Ingress, systemDefaultBackend utils.ServicePortID, namer *namer_util.Namer) (*utils.GCEURLMap, []error) {
	var errs []error
